...
declare type LoadFunctionalityComponents<P = {}> = (nativeElement: NativeElement, values: MotionValuesMap, props: P & MotionProps, context: MotionContextProps, parentContext: MotionContextProps, controls: ValueAnimationControls<P>, inherit: boolean) => ReactElement<FunctionalProps>[];
 ...
 * @internal
 */
export declare class MagicMotion extends React.Component<Props, MagicMotionUtils> {
...
declare interface MagicMotionChild {
    id?: string;
    snapshot: () => Snapshot;
    resetRotation: () => void;
...
export declare const MagicMotionContext: React.Context<MagicMotionUtils | null>;

declare interface MagicMotionUtils {
 ...
 * @internal
 */
export declare function ReducedMotion({ children, enabled }: Props_2): JSX.Element;
...
declare type RenderComponent<P = {}> = (nativeElement: NativeElement, style: CSSProperties, values: MotionValuesMap, props: P, isStatic?: boolean) => ReactElement;
...
declare type Schedule = (job: Job) => void;
...
declare type Session = (schedule: Schedule) => void;
...
declare function syncTree(queueId: string, depth: number, session: Session): () => boolean;
