...
var NativeElement = /** @class */ (function () {
    ...
    NativeElement.prototype.mount = function (element) {
        ...
        this.styler = styler__default(element);
...
function useNativeElement(values, enableHardwareAcceleration, externalRef) {
    return useConstant(function () {
        ...
        nativeElement.onMount(subscriberSymbol, function () {
            ...
            nativeElement.styler = styler__default(element, {
...
var MagicMotionContext = React.createContext(null);
/**
...
var MagicMotion = /** @class */ (function (_super) {
    tslib.__extends(MagicMotion, _super);
    ...
    MagicMotion.prototype.forceRender = function () {
        this.setState(tslib.__assign({}, this.state));
    };
    ...
    MagicMotion.prototype.render = function () {
        ...
        return (React.createElement(MagicMotionContext.Provider, { value: this.state }, children));
    };
    return MagicMotion;
}(React.Component));
...
var Magic = /** @class */ (function (_super) {
    ...
    Magic.prototype.scheduleTransition = function (prev) {
        ...
        this.cancelTransition = this.sync("transition", localContext.depth, function (schedule) {
            ...
            schedule(function () {
                ...
                localContext.deltas = tslib.__spreadArrays((parentContext.deltas || []), [
                    _this.delta,
                ]);
            });
    ...
    Magic.prototype.transitionLayout = function () {
        ...
        var updateBoundingBoxes = function () {
            ...
            easedNext.x.min = popcorn.mix(_this.next.layout.x.min, _this.prev.layout.x.min, p);
            easedNext.x.max = popcorn.mix(_this.next.layout.x.max, _this.prev.layout.x.max, p);
            easedNext.y.min = popcorn.mix(_this.next.layout.y.min, _this.prev.layout.y.min, p);
            easedNext.y.max = popcorn.mix(_this.next.layout.y.max, _this.prev.layout.y.max, p);
            ...
            if (isRotationAnimating) {
                values
                    .get("rotate", 0)
                    .set(popcorn.mix(_this.prev.style.rotate, _this.next.style.rotate, p));
            }
            // TODO: Only do this if we're animating border radius or border radius doesnt equal 0
            _this.prevBorderRadius = popcorn.mix(_this.prev.style.borderRadius, _this.next.style.borderRadius, p);
...
function createDomMotionConfig(Component) {
    ...
    return {
        renderComponent: function (nativeElement, style, values, props, isStatic) {
            ...
            return React.createElement(Component, tslib.__assign(tslib.__assign(tslib.__assign({}, forwardedProps), { ref: nativeElement.ref }), staticVisualStyles));
        },
        /**
        ...
        loadFunctionalityComponents: function (nativeElement, values, props, context, parentContext, controls, inherit) {
            ...
            for (var i = 0; i < numFunctionalityComponents; i++) {
                ...
                if (shouldRender(props, parentContext)) {
                    activeComponents.push(React.createElement(Component_1, tslib.__assign({ key: key }, props, { localContext: context, parentContext: parentContext, values: values, controls: controls, nativeElement: nativeElement })));
                }
            }
...
var AnimatePresence = function (_a) {
    ...
    var syncLayoutContext = React.useContext(MagicMotionContext);
...
exports.MagicMotionContext = MagicMotionContext;
